<template>
  <div class="compulsoryDiv">
    ...
    <div class="complete">
      ...
      <div class="tabData">
        <!-- 未完成计划的div内容显示-->
        <div v-if="compulsoryActive === 0" :style="{'display':viewStyle==2?'flex':'block','padding-left':'0rem','padding-right':'0rem','padding-top':viewStyle==2?'0.1rem':'0rem','padding-bottom':viewStyle==2?'0.1rem':'0rem'}">
        ...
        <!-- 已完成计划的div内容显示-->
        <div v-if="compulsoryActive === 1" :style="{'display':viewStyle==2?'flex':'block','padding-left':'0rem','padding-right':'0rem','padding-top':viewStyle==2?'0.1rem':'0rem','padding-bottom':viewStyle==2?'0.1rem':'0rem'}">
